...
if checkbox1 :
    ...
    Delta_2['S&P_500_ETF'] = np.zeros(len(Delta_2)) /  (Delta['{}_net_pv'.format(Ticker_s[0])].values) 
    Delta_2['NASDAQ_100_ETF'] =  np.zeros(len(Delta_2)) / (Delta['{}_net_pv'.format(Ticker_s[1])].values)  
    Delta_2['Gold_ETF'] =   np.zeros(len(Delta_2)) /  (Delta['{}_net_pv'.format(Ticker_s[2])].values)  
    Delta_2['{}'.format(Ticker_s[3])] = np.zeros(len(Delta_2)) / (Delta['{}_net_pv'.format(Ticker_s[3])].values)  
