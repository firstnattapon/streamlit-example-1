...
if checkbox1 :
    ...
    fig = px.density_heatmap(tickerData_2 , x="Diff", y="Close",   marginal_y="histogram"  , text_auto=True , nbinsy=number , color_continuous_scale = ['rgb(36, 86, 104)', 'rgb(15, 114, 121)', 'rgb(13, 143, 129)', 'rgb(57, 171, 126)', 'rgb(110, 197, 116)', 'rgb(169, 220, 103)', 'rgb(237, 239, 93)'] )
