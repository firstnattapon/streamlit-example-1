...
if checkbox1 :
    ...
    fig = px.density_heatmap(tickerData_2 , x="Diff", y="Close",   marginal_y="histogram"  , text_auto=True , nbinsy=number , color_continuous_scale =  px.colors.sequential.Viridis  )
