...
def render_charts(config: Dict[str, Any], clients: Tuple):
    ...
    st.write("📊 Interactive Portfolio Charts (Powered by Recharts)")
...
export default PortfolioCharts;
    ...
    # ใน Streamlit, คุณสามารถใช้ st.markdown เพื่อ display หรือ integrate กับ custom component
    # แต่สำหรับ artifact, เราสามารถ generate มันที่นี่
    ...
    st.info("Note: เพื่อ render TSX นี้ใน Streamlit, ใช้ streamlit.components.v1.html กับ bundled React app หรือ deploy เป็น separate frontend.")
