...
def clear_all_caches():
    ...
    sell.cache_clear()
    buy.cache_clear()
    # NOTE: We no longer clear st.session_state here.
    # This preserves UI state (like the selectbox choice) across reruns,
    # while still allowing data caches to be refreshed.
