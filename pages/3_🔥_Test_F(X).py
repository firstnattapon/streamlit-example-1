...
with tab1:
    ...
    # 2. Build the list of available options
    ...
    # ถ้าไม่มี flag (เป็นการ rerun ปกติ) ให้ตรวจสอบและรีเซ็ตเหมือนเดิม
    # แต่ถ้ามี flag (เพิ่งกดปุ่ม GO) ให้ข้ามการตรวจสอบนี้ไป
