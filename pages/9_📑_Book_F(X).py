...
- Second-Level Thinking (second opinion)? เป็นกุญแจสำคัญในการสร้างผลตอบแทนที่เหนือกว่าตลาด โดยต้องคิดลึกกว่า มองแตกต่างและอดทนมากกว่านักลงทุนทั่วไป.
''')

st.markdown('''
###### สรุปบทที่ 2: ประสิทธิภาพของตลาดและข้อจำกัด
- ตลาดมีประสิทธิภาพส่วนใหญ่ แต่ไม่สมบูรณ์แบบ ความไม่สมบูรณ์แบบไร้ประสิทธิภาพเกิดจาก อารมณ์ของมนุษย์ 
''')

st.markdown('''
###### สรุปบทที่ 3: สรุปบทที่ 3: คุณค่า" (Value)
- (Value) คือรากฐานของการลงทุน "การลงทุนที่ประสบความสำเร็จคือการเข้าใจมูลค่าที่แท้จริง และซื้อในราคาที่ต่ำกว่านั้น"
''')
