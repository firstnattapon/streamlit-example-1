...
st.write('สรุปบทที่ 1 การคิดระดับสอง =/n   Second-Level Thinking เป็นกุญแจสำคัญในการสร้างผลตอบแทนที่เหนือกว่าตลาด โดยต้องคิดลึกกว่า มองต่างจาก และอดทนมากกว่านักลงทุนทั่วไป.') 
st.write('สรุปบทที่ 2 ประสิทธิภาพของตลาดและข้อจำกัด =/n ตลาดมีประสิทธิภาพ ส่วนใหญ่ แต่ไม่สมบูรณ์แบบ เพราะความไร้ประสิทธิภาพเกิดจาก อารมณ์มนุษย์ ') 
