...
if full_config:
    # 2. สร้าง UI ให้ผู้ใช้เลือก Ticker จาก config ที่โหลดมา
    # ใช้ st.multiselect แทน st.text_input + eval() เพื่อความปลอดภัยและ User-friendly
