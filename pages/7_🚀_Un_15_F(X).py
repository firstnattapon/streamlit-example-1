...
if checkbox1 :
    Delta_2 = Delta
    Delta_2['FFWM'] =  ( Delta.FFWM_net_pv.values  /   abs(np.max(Buffer.FFWM_Buffer.values))) *100
    Delta_2['NEGG'] = ( Delta.NEGG_net_pv.values  /    abs(np.max(Buffer.NEGG_Buffer.values))) *100
